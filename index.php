	...
	<div class="container">
		...
		<div class="c-navbar-wrapper clearfix">
			...
			<ul class="nav navbar-nav c-theme-nav">
				...
				<li class="c-menu-type-classic">
					<a href="" class="c-link dropdown-toggle">Features</a>
					<ul class="dropdown-menu c-menu-type-classic c-pull-left">
						...
						<li class="dropdown-submenu">
							...
							<ul class="dropdown-menu c-pull-right">
								<li>
									<a href="footer-ext-1.html#footer">Footer - Extended v1</a>
								</li>
								<li>
									<a href="footer-ext-2.html#footer">Footer - Extended v2</a>
								</li>
								<li>
									<a href="footer-ext-3.html#footer">Footer - Extended v3</a>
								</li>
								<li>
									<a href="footer-default.html#footer">Footer - Contact Form</a>
								</li>
								<li>
									<a href="footer-compact.html#footer">Footer - Compact</a>
								</li>
							</ul>
						</li>
						<li class="dropdown-submenu">
						...
						<li class="dropdown-submenu">
							...
							<ul class="dropdown-menu c-pull-right">
								<li>
									<a href="megamenu-extended.html">Mega Menu - Extended</a>
								</li>
								<li>
						...
						<li class="dropdown-submenu c-active">
							<a href="page-extended-portfolio.html">Multi Level Menu</a>
							<ul class="dropdown-menu c-pull-right">
								<li>
				...
				<li>
					<a href="#" class="c-link dropdown-toggle">Pages</a>
				...
				<li class="c-active c-menu-type-classic">
					<a href="#" class="c-link dropdown-toggle">Portfolio</a>
					<ul class="dropdown-menu c-menu-type-classic c-pull-left">
						<li>
				...
				<li>
					<a href="#" class="c-link dropdown-toggle">Components</a>
					<ul class="dropdown-menu c-menu-type-mega c-menu-type-fullwidth" style="min-width: auto">
						<li>
							<ul class="dropdown-menu c-menu-type-inline">
								<li>
								...
								<li>
									<a href="component-features-1.html">Feature Blocks 1</a>
								</li>
								<li>
								...
								<li>
									<a href="component-abouts.html">Abouts</a>
								</li>
								<li>
...
<div class="c-layout-page">
	...
	<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold">Extended Portfolio</h3>
			</div>
			...
			<div class="cbp-panel">
				...
				<div id="grid-container" class="cbp cbp-l-grid-masonry-projects">
					...
					<div class="cbp-item identity web-design">
						<div class="cbp-caption">
							<div class="cbp-caption-defaultWrap">
								<img src="assets/base/img/content/stock/56.jpg" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="c-masonry-border">
								</div>
						...
						<a href="ajax/projects/project5.html" class="cbp-singlePage cbp-l-grid-masonry-projects-title">Where TO App</a>
						<div class="cbp-l-grid-masonry-projects-desc">
							web design / identity
						</div>
					</div>
					...
					<div class="cbp-item identity web-design">
						<div class="cbp-caption">
							<div class="cbp-caption-defaultWrap">
								<img src="assets/base/img/content/stock/37.jpg" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="c-masonry-border">
								</div>
					...
					<div class="cbp-item graphic logos">
						<div class="cbp-caption">
							<div class="cbp-caption-defaultWrap">
								<img src="assets/base/img/content/stock/41.jpg" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="c-masonry-border">
								</div>
					...
					<div class="cbp-item identity graphic">
						<div class="cbp-caption">
							<div class="cbp-caption-defaultWrap">
								<img src="assets/base/img/content/stock/47.jpg" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="c-masonry-border">
								</div>
					...
					<div class="cbp-item web-design graphic">
						<div class="cbp-caption">
							<div class="cbp-caption-defaultWrap">
								<img src="assets/base/img/content/stock/36.jpg" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="c-masonry-border">
								</div>
					...
					<div class="cbp-item identity web-design">
						<div class="cbp-caption">
							<div class="cbp-caption-defaultWrap">
								<img src="assets/base/img/content/stock/45.jpg" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="c-masonry-border">
								</div>
					...
					<div class="cbp-item identity logos">
						<div class="cbp-caption">
							<div class="cbp-caption-defaultWrap">
								<img src="assets/base/img/content/stock/33.jpg" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="c-masonry-border">
								</div>
	...
	<div class="c-content-box c-size-md c-bg-parallax" style="background-image: url(assets/base/img/content/backgrounds/bg_oswald_1.jpg)">
		<div class="container">
			<div class="c-content-bar-4">
				...
				<div class="c-actions">
					...
					<a href="#" class="btn btn-md c-btn-red c-btn-square hide c-btn-uppercase c-btn-bold c-margin-b-100">Purchase</a>
				</div>
			</div>
		</div>
	</div>
